...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-black p-6 text-white">
      {step === 'inicio' && (
        <section className="text-center space-y-6">
          ...
          <div className="mt-6 flex justify-center space-x-6">
            <a href="https://www.instagram.com/Tjovefi" target="_blank" rel="noopener noreferrer" className="text-2xl text-zinc-300 hover:text-green-400">
              Instagram
            </a>
            <a href="https://www.youtube.com/Tjovefi" target="_blank" rel="noopener noreferrer" className="text-2xl text-zinc-300 hover:text-green-400">
              YouTube
            </a>
            <a href="https://www.tiktok.com/@Tjovefi" target="_blank" rel="noopener noreferrer" className="text-2xl text-zinc-300 hover:text-green-400">
              TikTok
            </a>
            <a href="mailto:Tjovefi@gmail.com" className="text-2xl text-zinc-300 hover:text-green-400">
              E-mail
            </a>
          </div>
        </section>
      ...
      {/* Outros passos... */}
      {/* (As outras seções de código permanecem as mesmas, com base no que você já tem acima) */}
    </main>
  )
}
